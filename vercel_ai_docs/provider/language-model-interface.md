...
- [Provider Registry](/provider/registry) — 按名称查找 Provider
- [OpenAI 适配器](/provider/openai-adapter) — 具体实现示例
- [版本兼容](/provider/version-compat) — V2→V4 适配
- [wrapLanguageModel](/middleware/wrap-model) — 中间件包装

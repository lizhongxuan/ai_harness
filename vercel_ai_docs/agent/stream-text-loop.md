...
- [generateText 循环](/agent/generate-text-loop) — 阻塞式版本
- [Web Streams 基础](/streaming/web-streams) — 底层流 API
- [smoothStream](/streaming/smooth-stream) — 输出平滑详解
- [SSE 传输](/streaming/sse-transport) — 服务端推送

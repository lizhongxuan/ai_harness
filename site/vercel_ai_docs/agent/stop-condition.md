...
- [generateText 循环](/vercel_ai_docs/agent/generate-text-loop) — 停止条件的使用场景
- [ToolLoopAgent](/vercel_ai_docs/agent/tool-loop-agent) — 默认 isStepCount(20)
- [工具审批](/vercel_ai_docs/tools/tool-approval) — 另一种终止触发

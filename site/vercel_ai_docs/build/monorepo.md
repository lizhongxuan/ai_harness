...
- [多框架支持](/vercel_ai_docs/ui/multi-framework) — 多包协作的典型场景
- [Provider Registry](/vercel_ai_docs/provider/registry) — 50+ Provider 的统一管理
- [设计模式](/vercel_ai_docs/appendix/patterns) — Monorepo 中的设计模式

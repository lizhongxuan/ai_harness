...
1. [generateText 循环](/vercel_ai_docs/agent/generate-text-loop) — 理解核心 Agent Loop
2. [LanguageModel 接口](/vercel_ai_docs/provider/language-model-interface) — 理解 Provider 抽象
3. [类型安全工具](/vercel_ai_docs/tools/type-safe-tools) — 理解工具系统
4. [Web Streams 基础](/vercel_ai_docs/streaming/web-streams) — 理解流式处理
5. [wrapLanguageModel](/vercel_ai_docs/middleware/wrap-model) — 理解中间件
6. [useChat](/vercel_ai_docs/ui/use-chat) — 理解 UI 集成

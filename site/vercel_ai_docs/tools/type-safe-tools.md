...
- [generateText 循环](/vercel_ai_docs/agent/generate-text-loop) — 工具在循环中的执行
- [工具审批](/vercel_ai_docs/tools/tool-approval) — 工具执行前的审批机制
- [工具修复](/vercel_ai_docs/tools/tool-repair) — 工具调用参数修复
- [TypeScript 泛型](/vercel_ai_docs/types/generics) — 泛型推导详解

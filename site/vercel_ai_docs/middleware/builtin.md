...
- [wrapLanguageModel](/vercel_ai_docs/middleware/wrap-model) — 中间件系统核心
- [LanguageModel 接口](/vercel_ai_docs/provider/language-model-interface) — 被包装的接口
- [Web Streams 基础](/vercel_ai_docs/streaming/web-streams) — 流式中间件的基础

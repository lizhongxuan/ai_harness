...
- [Web Streams 基础](/vercel_ai_docs/streaming/web-streams) — TransformStream 原理
- [streamText 流式循环](/vercel_ai_docs/agent/stream-text-loop) — smoothStream 的使用场景
- [SSE 传输](/vercel_ai_docs/streaming/sse-transport) — 平滑后的流如何发送到客户端

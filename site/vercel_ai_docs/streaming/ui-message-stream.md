...
- [SSE 传输](/vercel_ai_docs/streaming/sse-transport) — UIMessageStream 的传输层
- [useChat](/vercel_ai_docs/ui/use-chat) — 客户端消费 UIMessageStream
- [streamText 流式循环](/vercel_ai_docs/agent/stream-text-loop) — UIMessageStream 的数据源

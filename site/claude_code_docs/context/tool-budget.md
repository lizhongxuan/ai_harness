...
- [五层防爆体系](/claude_code_docs/context/five-layers) — 预算系统是 L1 的核心
- [工具结果落盘](/claude_code_docs/tools/tool-persist) — 落盘的具体实现
- [Prompt Cache 优化](/claude_code_docs/context/prompt-cache) — 冻结机制服务于 cache 稳定性

...
- [Prompt Cache 优化](/claude_code_docs/context/prompt-cache) — API 层的 prompt cache 机制
- [CLAUDE.md 发现机制](/claude_code_docs/data/claudemd) — CLAUDE.md 内容作为 system prompt 分区
- [Feature Flag 编译期消除](/claude_code_docs/build/feature-flag) — feature flag 影响哪些分区被包含

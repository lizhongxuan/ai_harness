...
- [自研 Ink 渲染引擎](/claude_code_docs/ui/ink-engine) — 全屏模式的底层渲染管线
- [极简状态管理](/claude_code_docs/data/store) — `useAppState` 驱动 REPL 的状态更新
- [会话持久化与恢复](/claude_code_docs/data/session) — transcript JSONL 的写入和读取

...
- [System Prompt 分区缓存](/claude_code_docs/build/prompt-section) — CLAUDE.md 内容作为 system prompt 的一个分区
- [五层上下文防爆体系](/claude_code_docs/context/five-layers) — 单文件 40K 字符限制是 L1 源头控制的一部分
- [会话持久化与恢复](/claude_code_docs/data/session) — 会话恢复时重新加载 CLAUDE.md

...
- [压缩意图保持](/claude_code_docs/context/compact-intent) — compact-boundary 中的摘要格式
- [全屏模式的消息管理](/claude_code_docs/ui/fullscreen) — UI 消息 vs transcript 消息的区别
- [CLAUDE.md 发现机制](/claude_code_docs/data/claudemd) — 会话恢复时重新加载 CLAUDE.md

...
**阶段 4: 错误恢复** — 详见 [多级错误恢复](/claude_code_docs/agent/error-recovery)
...
- [多级错误恢复](/claude_code_docs/agent/error-recovery) — 阶段 4 的详细展开
- [五层防爆体系](/claude_code_docs/context/five-layers) — 阶段 1 的上下文预处理
- [工具类型系统](/claude_code_docs/tools/tool-type) — 阶段 5 的工具执行

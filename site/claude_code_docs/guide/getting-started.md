...
1. [ReAct 循环工程化](/claude_code_docs/agent/react-loop) — 理解核心循环
2. [五层防爆体系](/claude_code_docs/context/five-layers) — 理解上下文管理
3. [工具类型系统](/claude_code_docs/tools/tool-type) — 理解工具如何工作
4. [编码行为约束](/claude_code_docs/prompt/coding-prompt) — 理解提示词设计

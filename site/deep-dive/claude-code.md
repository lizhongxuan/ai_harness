...
::: tip 知识点导航
本文涉及的 Claude Code 源码分析文章：
- [ReAct 循环工程化实现](/claude_code_docs/agent/react-loop) — Agent Loop 核心架构
- [五层上下文管理体系](/claude_code_docs/context/five-layers) — 多级压缩管道
- [Compact 意图压缩策略](/claude_code_docs/context/compact-intent) — Auto-Compact 实现
- [Prompt Cache 机制](/claude_code_docs/context/prompt-cache) — 缓存与 Microcompact
- [CLAUDE.md 持久化配置](/claude_code_docs/data/claudemd) — 用户规则记忆
- [会话数据管理](/claude_code_docs/data/session) — 会话记忆系统
- [多级错误恢复策略](/claude_code_docs/agent/error-recovery) — 错误恢复链路
- [工具调用 Token 预算](/claude_code_docs/context/tool-budget) — Token Budget
- [Token 估算与计费](/claude_code_docs/api/token-estimate) — 成本追踪
- [工具权限管理](/claude_code_docs/tools/permission) — 沙箱与权限
:::
...
> 📖 详细源码分析：[ReAct 循环工程化实现](/claude_code_docs/agent/react-loop)
...
- `'stop_hook_blocking'` — stop hook 阻止了完成（参见 [Hook 系统](/claude_code_docs/agent/hook-system)）
...
> 📖 详细源码分析：[五层上下文管理体系](/claude_code_docs/context/five-layers) | [Compact 意图压缩策略](/claude_code_docs/context/compact-intent)
...
> 📖 参见：[工具调用 Token 预算](/claude_code_docs/context/tool-budget)
...
> 📖 参见：[Prompt Cache 机制](/claude_code_docs/context/prompt-cache)
...
> 📖 参见：[Compact 意图压缩策略](/claude_code_docs/context/compact-intent)
...
> 📖 参见：[多级错误恢复策略](/claude_code_docs/agent/error-recovery)
...
> 📖 详细源码分析：[CLAUDE.md 持久化配置](/claude_code_docs/data/claudemd) | [会话数据管理](/claude_code_docs/data/session)
...
> 📖 参见：[数据存储架构](/claude_code_docs/data/store) — 记忆持久化底层机制
...
> 📖 详细源码分析：[多级错误恢复策略](/claude_code_docs/agent/error-recovery)
...
> 📖 详细源码分析：[工具调用 Token 预算](/claude_code_docs/context/tool-budget) | [Token 估算与计费](/claude_code_docs/api/token-estimate)
...
> 📖 参见：[ReAct 循环工程化实现](/claude_code_docs/agent/react-loop) — 流式工具执行部分
...
> 📖 参见：[工具权限管理](/claude_code_docs/tools/permission) | [工具类型体系](/claude_code_docs/tools/tool-type)
...
以下是 Claude Code 项目文档站中与本文各章节对应的详细源码分析文章：

### Agent 核心架构

- [ReAct 循环工程化实现](/claude_code_docs/agent/react-loop) — queryLoop 主循环、StreamingToolExecutor、State 对象设计
- [多级错误恢复策略](/claude_code_docs/agent/error-recovery) — PTL/max-output-tokens/fallback 完整恢复链路
- [Hook 系统](/claude_code_docs/agent/hook-system) — stop hooks、pre/post tool hooks
- [子 Agent 架构](/claude_code_docs/agent/sub-agent) — 子 Agent 的上下文隔离与恢复

### 上下文管理

- [五层上下文管理体系](/claude_code_docs/context/five-layers) — L1-L7 完整压缩管道
- [Compact 意图压缩策略](/claude_code_docs/context/compact-intent) — Auto-Compact 的结构化摘要与断路器
- [Prompt Cache 机制](/claude_code_docs/context/prompt-cache) — 缓存 TTL、Microcompact、frozen 分区
- [工具调用 Token 预算](/claude_code_docs/context/tool-budget) — per-tool 截断、contentReplacementState

### 数据与记忆

- [CLAUDE.md 持久化配置](/claude_code_docs/data/claudemd) — 目录树合并、compact 后重载
- [会话数据管理](/claude_code_docs/data/session) — SessionMemory、sideQuery 语义检索
- [数据存储架构](/claude_code_docs/data/store) — 底层持久化机制

### API 与工具

- [Token 估算与计费](/claude_code_docs/api/token-estimate) — budgetTracker、成本追踪
- [MCP 集成](/claude_code_docs/api/mcp) — MCP 上下文注入
- [工具权限管理](/claude_code_docs/tools/permission) — 沙箱权限流程
- [工具类型体系](/claude_code_docs/tools/tool-type) — 工具分类与 schema
- [工具持久化](/claude_code_docs/tools/tool-persist) — 工具结果持久化

### 构建与 Prompt

- [Feature Flag 体系](/claude_code_docs/build/feature-flag) — 功能开关控制
- [Prompt Section 架构](/claude_code_docs/build/prompt-section) — system prompt 组装
- [设计模式总结](/claude_code_docs/appendix/patterns) — 架构模式与最佳实践

...
详见 [子 Agent 委托](/hermes_agent_docs/agent/subagent)。
...
- [工具注册表](/hermes_agent_docs/tools/registry) — 工具的注册和分发机制
- [并行工具执行](/hermes_agent_docs/agent/parallel-tools) — 工具的并行安全分类
- [工具审批](/hermes_agent_docs/tools/approval) — 工具执行的安全检查

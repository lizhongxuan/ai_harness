...
- [平台适配器](/hermes_agent_docs/gateway/platforms) — 各平台的具体实现
- [网关 Hook](/hermes_agent_docs/gateway/hooks) — Hook 系统的扩展机制
- [Toolset 系统](/hermes_agent_docs/skills/toolsets) — 平台级 toolset 定义

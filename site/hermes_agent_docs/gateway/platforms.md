...
- [网关架构](/hermes_agent_docs/gateway/architecture) — 网关的整体分层
- [Toolset 系统](/hermes_agent_docs/skills/toolsets) — 平台级 toolset 的组合机制
- [网关 Hook](/hermes_agent_docs/gateway/hooks) — 平台事件的扩展点

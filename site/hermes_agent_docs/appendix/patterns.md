...
**详见**: [双 Agent 循环](/hermes_agent_docs/agent/dual-loop)
...
**详见**: [工具注册表](/hermes_agent_docs/tools/registry)
...
**源码**: `toolsets.py`
**详见**: [Toolset 系统](/hermes_agent_docs/skills/toolsets)
...
**详见**: [记忆管理器](/hermes_agent_docs/memory/manager)
...
**详见**: [上下文压缩器](/hermes_agent_docs/context/compressor)
...
**详见**: [智能模型路由](/hermes_agent_docs/api/smart-routing)
...
**详见**: [多 Provider 支持](/hermes_agent_docs/api/multi-provider)
...
**详见**: [平台适配器](/hermes_agent_docs/gateway/platforms)
...
**详见**: [技能系统](/hermes_agent_docs/skills/skill-system)
...
**源码**: `model_tools.py`
**详见**: [工具类型](/hermes_agent_docs/tools/tool-types)

...
- [Toolset 系统](/hermes_agent_docs/skills/toolsets) — 技能条件激活依赖的 toolset 解析
- [双 Agent 循环](/hermes_agent_docs/agent/dual-loop) — 技能索引在系统提示词中的注入位置
- [工具类型](/hermes_agent_docs/tools/tool-types) — 技能管理工具（skill_view、skill_manage）

...
- [双 Agent 循环](/hermes_agent_docs/agent/dual-loop) — 并行执行在 AIAgent 循环中的位置
- [工具注册表](/hermes_agent_docs/tools/registry) — 工具的注册和分发
- [工具类型](/hermes_agent_docs/tools/tool-types) — 各类工具的特性

...
hero:
  ...
  actions:
    - theme: brand
      text: 快速开始
      link: /hermes_agent_docs/guide/getting-started
    - theme: alt
      text: 学习路线
      link: /hermes_agent_docs/appendix/roadmap

features:
  - icon: 🔄
    title: Agent 架构
    details: 双 Agent 循环、并行工具执行、迭代预算、子 Agent 委托
    link: /hermes_agent_docs/agent/dual-loop
  - icon: 🌐
    title: 多平台网关
    details: 15+ 平台适配器、会话管理、Hook 系统、流式消费
    link: /hermes_agent_docs/gateway/architecture
  - icon: 🧩
    title: 技能生态
    details: 50+ 技能目录、SKILL.md 格式、条件激活、两层缓存
    link: /hermes_agent_docs/skills/skill-system
  - icon: 🗜️
    title: 上下文压缩
    details: 结构化 LLM 摘要、迭代更新、轨迹压缩、50% 阈值
    link: /hermes_agent_docs/context/compressor
  - icon: 🧠
    title: 记忆系统
    details: MemoryManager、内置 + 外部 Provider、上下文围栏
    link: /hermes_agent_docs/memory/manager
  - icon: 🔧
    title: 工具系统
    details: ToolRegistry 自注册、30+ Toolset、类型强转、审批机制
    link: /hermes_agent_docs/tools/registry
  - icon: 🎯
    title: RL 训练
    details: 轨迹保存/压缩、批量运行器、Atropos 集成
    link: /hermes_agent_docs/rl/agent-loop
  - icon: 📐
    title: 设计模式
    details: 13+ 种可复用的架构模式速查
    link: /hermes_agent_docs/appendix/patterns
---

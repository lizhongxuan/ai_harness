...
- [智能模型路由](/hermes_agent_docs/api/smart-routing) — cheap/strong 模型切换
- [上下文压缩器](/hermes_agent_docs/context/compressor) — 使用辅助模型生成摘要
- [双 Agent 循环](/hermes_agent_docs/agent/dual-loop) — API 调用在循环中的位置

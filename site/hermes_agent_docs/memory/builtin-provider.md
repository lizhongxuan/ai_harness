...
- [记忆管理器](/hermes_agent_docs/memory/manager) — Provider 的注册和编排
- [技能系统](/hermes_agent_docs/skills/skill-system) — 技能是另一种持久知识形式
- [双 Agent 循环](/hermes_agent_docs/agent/dual-loop) — 记忆在循环中的注入时机

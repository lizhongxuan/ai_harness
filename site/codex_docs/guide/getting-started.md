...
1. [事件驱动循环](/codex_docs/agent/event-loop) — 理解核心 Agent Loop
2. [沙箱架构总览](/codex_docs/sandbox/architecture) — 理解安全模型（Codex 的核心差异化）
3. [策略引擎](/codex_docs/execpolicy/policy-engine) — 理解命令审批
4. [Shell 工具](/codex_docs/tools/shell-tool) — 理解工具执行
5. [自动压缩](/codex_docs/context/auto-compact) — 理解上下文管理

...
详见 [轨迹压缩器](/context/trajectory-compressor)。
...
- [轨迹压缩器](/context/trajectory-compressor) — 压缩算法详解
- [RL Agent 循环](/rl/agent-loop) — 轨迹的生成源
- [双 Agent 循环](/agent/dual-loop) — AIAgent 的轨迹保存

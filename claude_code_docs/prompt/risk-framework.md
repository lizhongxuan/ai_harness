...
- [权限模式](/tools/permission) — 硬约束层面的工具权限控制
- [编码行为约束](/prompt/coding-prompt) — 约束"代码质量"，风险框架约束"操作安全"
- [Hook 系统](/agent/hook-system) — PreToolUse hooks 可以实现自定义的风险检查
- [CLAUDE.md 发现](/data/claudemd) — 用户可以在 CLAUDE.md 中预授权特定操作
